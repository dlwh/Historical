...
find--among other things--that Portuguese \textit{/\textipa{1}/},
...
\textit{\textipa{/nombRar/}} ``name'' is grouped together with
Portuguese \textit{/num\textipa{1RaR}/} ``number'' and Italian

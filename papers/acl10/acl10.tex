...
the example of English ``day'' \textit{/\textipa{deI}/} and Latin
``di\=es,'' \textit{/\textipa{dIe:s}/} both with the same meaning.
...
the sound change \textit{/\textipa{I}/}$ \to $\textit{/\textipa{eI}/}.
